...
import { addUserlogin } from "../services/ApiService";
function Registerc(){
...
return(
   ...
   <br/>
    ...
    <div class="col-md-9 col-lg-6 col-xl-3" style={{ width: "30%" }}>
      ...
      <div class="col-md-7 col-lg-5 col-xl-5 offset-xl-1">
        ...
        <form>
         ...
         <input type="password" id="password"  class="form-control form-control-lg rounded" />
          ...
          <p class="small fw-bold mt-2 pt-1 mb-0">Utilisateur existant ?  <a href="/Loginc"
